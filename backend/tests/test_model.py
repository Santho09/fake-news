...
try:
    ...
    from backend.src.model import FakeNewsClassifier, ModelComparison
    from backend.src.data_processing import DataLoader, TextPreprocessor, FeatureExtractor  # type: ignore
